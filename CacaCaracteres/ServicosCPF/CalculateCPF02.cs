...
public class CalculateCPF02
{
    public static bool PreperCPF(string sourceCPF)
    {
        if (String.IsNullOrWhiteSpace(sourceCPF))
        {
            Console.WriteLine("Erro: String.IsNullOrWhiteSpace");
            return false;
        }
        ...
        if (clearCPF.Equals("00000000000") ||
            ...
            clearCPF.Equals("99999999999")) return false;
        ...
        if (clearCPF[9] != modI) return false;
        ...
        if (clearCPF[10] != modII) return false;
